package dongwei.fajuary.movedimensionapp.apkupdate;
...
import dongwei.fajuary.movedimensionapp.apkupdate.config.SystemParams;
...
//        context.startActivity(install);
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile(context, "dongwei.fajuary.polybeautyapp.fileProvider", apkFile);

 ...
 * 关于动维
 */
public class AboutDynamicdimensionActivity extends BaseHasLeftActivity {


    @BindView(R.id.activity_dynamicdimension_mWebView)
    ...
    public int getLayoutId() {
        return R.layout.activity_about_dynamicdimension;
    }

    @Override
    public void newInitView() {

        titleTxt.setText("关于动维");
        ...
        OkGo.<String>post(HttpUtils.getRuleByTypeUrl)//
                ...
                .execute(new StringDialogCallback(this) {
                    ...
                    public void onError(Response<String> response) {
                        ...
                        ToastHelper.showTextToast(AboutDynamicdimensionActivity.this,"检查网络，请重试...");
                    }
                        ...
                        try {
                            ...
                            if (null != jsonObject) {
                                ...
                                if (status.equals("200")){
                                    ...
                                    ToastHelper.showTextToast(AboutDynamicdimensionActivity.this,"请重新登录");
                                    Intent intent=new Intent();
                                    intent.setClass(AboutDynamicdimensionActivity.this, LoginActivity.class);
                                    startActivity(intent);
                                }else {
                                    ToastHelper.showTextToast(AboutDynamicdimensionActivity.this,msgStr);
                                }
                            }

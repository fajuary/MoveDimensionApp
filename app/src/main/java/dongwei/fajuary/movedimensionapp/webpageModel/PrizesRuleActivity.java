 ...
 * 奖品规则
 */
public class PrizesRuleActivity extends BaseHasLeftActivity {

    @BindView(R.id.activity_prizesrule_mWebView)
    ...
    public int getLayoutId() {
        return R.layout.activity_prizes_rule;
    }
    ...
    public void newInitView() {
        if (null!=getIntent()){
            ...
            webtitleName=getIntent().getStringExtra("webtitleName");
        }
        titleTxt.setText(webtitleName);
        ...
        OkGo.<String>post(HttpUtils.getRuleByTypeUrl)//
                ...
                .execute(new StringDialogCallback(this) {
                    ...
                    public void onError(Response<String> response) {
                        ...
                        ToastHelper.showTextToast(PrizesRuleActivity.this,"检查网络，请重试...");
                    }
                        ...
                        try {
                            ...
                            if (null != jsonObject) {
                                ...
                                if (status.equals("200")){
                                    ...
                                    ToastHelper.showTextToast(PrizesRuleActivity.this,"请重新登录");
                                    Intent intent=new Intent();
                                    intent.setClass(PrizesRuleActivity.this, LoginActivity.class);
                                    startActivity(intent);
                                }else {
                                    ToastHelper.showTextToast(PrizesRuleActivity.this,msgStr);
                                }
                            }
